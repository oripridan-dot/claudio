...
def main():
    ...
    print(f"Initializing Reverse Delta Tests...")
    ...
    infer_and_render(f0_sweep, loudness_sweep, z_sweep, "Pure Sine Sweep", f"{output_dir}/reverse_delta_sweep.wav", onnx_sess, synth)
    ...
    infer_and_render(f0_impulse, loudness_impulse, z_impulse, "Dirac Impulse", f"{output_dir}/reverse_delta_impulse.wav", onnx_sess, synth)
    ...
    infer_and_render(f0_void, loudness_void, z_void, "Absolute Void", f"{output_dir}/reverse_delta_void.wav", onnx_sess, synth)
